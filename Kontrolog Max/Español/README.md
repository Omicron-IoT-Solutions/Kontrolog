...
[El Firmware del Kontrolog Max (verificar y corregir link)](https://github.com/Omicron-IoT-Solutions/Kontrolog-Max/tree/No-Code/Firmware) contiene el código de fábrica predeterminado, que viene programado en el Kontrolog Max desde el momento en que lo recibes tras tu compra. Solo necesitas vincularlo a la interfaz gráfica HMI o a la plataforma web IoT para comenzar a configurar alarmas, entradas y salidas, y monitorear su estado.
...
A continuación, descarga el  [archivo .HMI (verificar y corregir link)](https://github.com/Omicron-IoT-Solutions/Kontrolog-Max/tree/No-Code/Display), el cual contiene el código que te proporcionamos para simular la pantalla HMI en NEXTION. Este mismo código está preconfigurado en las pantallas HMI que permiten programar el Kontrolog Max localmente en modo No-Code.
