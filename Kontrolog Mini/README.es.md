...
## Descripción
![Imagen11](https://github.com/user-attachments/assets/7572bf0d-4756-43e8-ac51-cae25d1564e3)
...
- Una (1) entrada de voltaje de alimentación de 12-28VDC, con medición de voltaje de alimentación en corriente continua.  
...
- Dos (2) salidas tipo relé normalmente abiertas, con rangos máximos de conmutación de 12A y 240VAC a 50-60Hz.  
...
- Puerto de comunicación, que permite conectar un módulo de comunicación dual con protocolos LoRaWAN™/Sigfox para las regiones de EE.UU./Europa/Latinoamérica/Australia, o utilizar la conectividad WiFi integrada del ESP32.  
