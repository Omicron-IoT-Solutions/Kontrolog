...
This branch contains the documentation and the basic header and source files that make up the **Board Support Package (BSP)** for the **Kontrolog Max**, along with examples and guided tutorials to help you program it in **Full-Code** mode.

---

## **📁 BSP Structure**

[Kontrolog\_Max\_BSP](https://github.com/Omicron-IoT-Solutions/Kontrolog/tree/Full-Code/Kontrolog%20Max/Kontrolog_Max_BSP)
...
To use the **Kontrolog Max** library, follow these steps:
...
> Useful keywords: `kontrolog`, `max`, `iot`, `esp32`, `plc`
